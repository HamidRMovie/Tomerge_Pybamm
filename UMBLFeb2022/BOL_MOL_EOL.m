...
A=load("Andrew_100DOD_experiment_refit_resis13e5_Mar18.mat");% resis 1.3e6
A3=load("Andrew_100DOD_experiment_epe_03_Mar9_3.mat"); % resis 1.5e6

B=readmatrix("/Users/hamid/piibamm/PyBaMM/UMBLFeb2022/data/UMBL2022FEB_CELL152002_cycling_data.csv");

t2=B(:,1); I2=-B(:,2)/1000; V2=B(:,3); cyc2=B(:,8);

C1=load("/Users/hamid/piibamm/PyBaMM/gmproj/cycling_aging/Peyman__cell13_July25.mat");

D=readmatrix("/Users/hamid/RC sys ID/Peyman2020/cycling/cycling_data_cell_13.csv");
t20=D(:,1); I20=-D(:,2)/1000; V20=D(:,3); cyc20=D(:,8);
...
figure(101)
hold on;
plot(t3-t3(1)+2,V2(cyc2==40),"-k",  'LineWidth',2 )
plot(t1-t1(1)-1,A.Vt_t(A.t<=A.cycle_time(1)),"-.r",  'LineWidth',2)
...
plot(t1-t1(1)-10,A.Vt_t(A.t<=A.cycle_time(880) & A.t>=A.cycle_time(879)),"-.b",  'LineWidth',2)
% hold on;
...
figure(101)
hold on;
plot(t3-t3(1),V2(cyc2==1279 ),"-k",  'LineWidth',2 )
plot(t1-t1(1)-10,A.Vt_t(A.t<=A.cycle_time(880) & A.t>=A.cycle_time(879)),"-.r",  'LineWidth',2)
...
Data1=readmatrix("/Users/hamid/piibamm/PyBaMM/UMBLFeb2022/data/esoh/aging_param_cell_152002.csv");
...
hold on;
t30=t20(cyc20==10)/60;
plot(t30-t30(1)+2,V20(cyc20==10),"-r",  'LineWidth',2 )

t10=C1.t(C1.t<=C1.cycle_time(10) & C1.t>=C1.cycle_time(9))/60;
t111=t10-t10(1)+2;
V111=C1.Vt_t(C1.t<=C1.cycle_time(10) & C1.t>=C1.cycle_time(9));

V111_1=V111(t111<150);
V111_2=V111(t111>=150);


V1112=[V111_2,V111_1];


plot(t111,V1112,"-.b",  'LineWidth',2)
hold on;
...
figure(100)
hold on;
plot(t30-t30(1),V20(cyc20==10),"-k",  'LineWidth',2 )
plot(t111,V1112,"-.r",  'LineWidth',2)
...
nexttile
hold on; 
t30=t20(cyc20==260)/60;
plot(t30-t30(1),V20(cyc20==260),"-r",  'LineWidth',2 )
t10=C1.t(C1.t<=C1.cycle_time(230) & C1.t>=C1.cycle_time(229))/60 ;


t111=t10-t10(1);
V111=C1.Vt_t(C1.t<=C1.cycle_time(230) & C1.t>=C1.cycle_time(229));
...
hold on; 
t30=t20(cyc20==530)/60;
plot(t30-t30(1),V20(cyc20==530),"-r",  'LineWidth',2 )

t10=C1.t(C1.t<=C1.cycle_time(450) & C1.t>=C1.cycle_time(449))/60 ;

t111=t10-t10(1);
V111=C1.Vt_t(C1.t<=C1.cycle_time(450) & C1.t>=C1.cycle_time(449));
...
figure(100)
hold on;
plot(t30-t30(1),V20(cyc20==530),"-k",  'LineWidth',2 )
plot(t111,V1112,"-.r",  'LineWidth',2)
